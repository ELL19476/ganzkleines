            ...
            $message =  '<!DOCTYPE html>
                ...
                <body>
                    <div style="text-align: center; padding: 20px;">
                        <h1>Welcome to <i>"Ganz Kleines"</i></h1>
                        <p>You are almost ready to vote! Please verify your email address by entering the code below:</p>
                        <h2 style="font-size: 24px;">' . $verification_code . '</h2>
                        <p>If you did not register at <a href="https://ganzkleines.de">ganzkleines.de</a>, please ignore this email.</p>
                    </div>
                </body>
            </html>';
            try {
